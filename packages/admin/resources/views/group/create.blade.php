...
@section('page-title')
    {{ trans('admin::pages/group.create.page_title') }}
@endsection
...
@section('page-header')
    - {{ trans('admin::pages/group.create.page_header') }}
@endsection
...
@section('page-content')
    ...
    {!! Form::open(['route' => ['admin::group.store'], 'id' => 'create-form', 'class' => 'has-max-width']) !!}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
