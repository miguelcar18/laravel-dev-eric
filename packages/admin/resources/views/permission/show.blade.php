...
@section('page-title')
    {{ trans('news::pages/permission.show.page_title') }}
@endsection
...
@section('page-header')
    - {{ trans('news::pages/permission.show.page_header') }}
@endsection
...
@section('breadcrumbs')
    @include('admin::partials.page.breadcrumbs', [ 'breadcrumbs' => [
        ...
        ['text' => trans('admin::pages/permission.show.breadcrumb')]
    ]])
@endsection
...
{{--            @foreach($permission->notifications as $an)--}}
{{--                <li>{{ $an }}</li>--}}
{{--            @endforeach--}}
{{--        </ul>--}}
{{--    </div>--}}
{{dd($permission)}}
    {!! Form::open(['route' => ['admin::permission.update', $permission], 'class' => 'has-max-width']) !!}
    {{ method_field('PUT') }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('name', old('name') ?? $permission->name, ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('slug', old('slug') ?? $permission->slug, ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('description', old('description') ?? $permission->description, ['class' => 'form-control', 'required' => true]) !!}
