...
@section('page-title')
    {{ trans('admin::pages/permission.index.page_title') }}
@endsection
...
@section('page-header')
    {{ trans('admin::pages/permission.index.page_header') }}
@endsection

@section('breadcrumbs')
    @include('admin::partials.page.breadcrumbs', [ 'breadcrumbs' => [
        ['text' => trans('admin::pages/permission.index.breadcrumb')]
    ]])
@endsection
                ...
                <div class="table-responsive">
                    <table id="server-side-data-table" class="table table-bordered table-hover table-striped table-light-dark">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('admin::pages/permission.index.columns.slug') }}</th>
                            <th>{{ trans('admin::pages/permission.index.columns.description') }}</th>
    ...
    <script type="text/javascript">
        const tableActionButtons = (data) => {
            ...
            // if (data.can_delete) {
                ...
                html+='data-sweet-alert-title="{{ trans('admin::pages/permission.index.destroy.alert.title') }}"';
                html+='data-sweet-alert-text="{{ trans('admin::pages/permission.index.destroy.alert.text') }}"';
        ...
        $(document).ready(function() {
            var table = $('#server-side-data-table').DataTable( {
                ...
                ajax: {
                    url: "{{ route('admin::api.permission.index') }}",
                    data: function ( d ) {
