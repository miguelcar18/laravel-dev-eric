            ...
            <form class="form-horizontal" method="POST" action="{{ route('articles.update',$article->id) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="title" value="{{ $article->title }}" readonly class="form-control" id="inputEmail4" placeholder="El Gran cambio">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Autor</label>
                        <input type="text" name="author" class="form-control" readonly value="{{ $article->author }}" placeholder="Andres Sojo">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputAddress">Cuerpo</label>
                    <textarea type="text" class="form-control" col="3" readonly name="body">{{$article->body}}</textarea>
                </div>
            </form>
        </div>
