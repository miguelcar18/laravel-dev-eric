            ...
            <form class="form-horizontal" method="POST" action="{{ route('news::author.update',$author->id) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="dni" class="form-control" value="{{ $author->dni }}" placeholder="15.148.156-R">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Email</label>
                        <input type="text" name="email" value="{{ $author->email }}" class="form-control" placeholder="Cheo">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="name" value="{{ $author->name }}" class="form-control" placeholder="Perez">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Apellido(s)</label>
                        <input type="text" name="lastName" value="{{ $author->lastName }}" class="form-control" placeholder="Gonzalez">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
