...
@section('page-title')
    {{ trans('news::pages/message.create.page_title') }}
@endsection
...
@section('page-header')
    - {{ trans('news::pages/message.create.page_header') }}
@endsection

@section('breadcrumbs')
    @include('admin::partials.page.breadcrumbs', [ 'breadcrumbs' => [
    ['text' => trans('news::pages/message.create.breadcrumb')]
]])
@endsection

@section('page-content')
    {!! Form::open(['route' => ['news::message.store'], 'id' => 'create-form', 'class' => 'has-max-width']) !!}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('sender_name', old('sender_name'), ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('sender_email', old('sender_email'), ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('answer_to', old('answer_to'), ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('footer_text', old('footer_text'), ['class' => 'form-control', 'required' => true]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('content', old('content'), ['class' => 'form-control textarea_content', 'required' => true ]) !!}
