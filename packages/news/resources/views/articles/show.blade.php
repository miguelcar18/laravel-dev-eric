...
<div class="relative flex items-top min-h-screen bg-gray-100 container dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="col-12 container">
        <a href="{{ route('news_articles.index') }}" class="btn btn-primary "> Articulos </a>
        <br/>
        <br/>
            ...
            <form class="form-horizontal" method="POST" action="{{ route('news_articles.update',$article->id) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ $article->title }}"
                               placeholder="El Gran cambio" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Subtitulo</label>
                        <input type="text" name="subtitle" value="{{ $article->subtitle }}" class="form-control"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="subtitle" value="{{ $article->asection }}" class="form-control"
                               placeholder="cambio" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Autor(s)</label>
                        <input type="text" name="subtitle" value="{{ $author->name.' '.$author->lastName }}" class="form-control"
                               placeholder="cambio" readonly>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea type="text" class="form-control" col="3" name="body" readonly>{{ $article->body }}</textarea>
                    </div>
